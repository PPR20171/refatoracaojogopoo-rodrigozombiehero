...
import jogorodrigozumbihero.proxys.MundoProxy;
public class Escopeta extends ArmaDeFogo{

    public Escopeta(String nome, int intensidadeDaArma) {
        super(nome,intensidadeDaArma,12,7,10,"");
    }
